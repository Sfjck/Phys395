...
pure function f2(x)
	...
	f2 = x**4.0 + 3.0*x**3.0 - 4.0*x**2.0 - 3.0*x + 4.0
end function

!the minima of the negative function is the maxima of the original!
pure function f2neg(x)
	real f2neg, x; intent(in) x
	f2neg = -x**4.0 - 3.0*x**3.0 + 4.0*x**2.0 + 3.0*x - 4.0
end function
end module
